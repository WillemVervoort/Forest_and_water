...
```{r model2a, echo = F}
linear_model_all_log <- gam(DeltaQf_perc ~ DeltaF_perc + Forest_Sign + Area_km2 + Pa_mm + Latitude + Longitude, data = Zhang_all2)
