...
There has been a recent push in the hydrological community [@evaristo2017] to use 'meta-analysis' to summarise past studies. The claim is that because a meta-analysis uses clearly defined search terms and statistical methods to analyse the results, that this will lead to more reliable summaries of past research. 
...
There is a real attraction in the meta-analysis idea of statistical analysis of past studies to be able to extrapolate findings to larger scales and to identify factors across global scales [@evaristo2017]. 
