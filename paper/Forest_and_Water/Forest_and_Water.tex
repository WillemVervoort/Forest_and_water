...
\midrule
\endhead
\textbf{(Intercept)} & 9.53 & 6.38 & 1.49 & 0.14 \\
\textbf{DeltaF\_perc\_pos} & 0.41 & 0.08 & 4.86 & 0 \\
\textbf{Forest\_SignIncrease} & -39.4 & 5.42 & -7.26 & 0 \\
\textbf{Dryness} & 1.59 & 2.7 & 0.59 & 0.56 \\
\bottomrule
\end{longtable}

The results from this model (equation \eqref{eq:eq5} and Table \ref{tab:out-model4}) interestingly indicate no impact of dryness modulating the change in streamflow as a function of the change in forest cover change, which is surprising in light of earlier reported results (Filoso et al., 2017; Zhang et al., 2017). In this case, the evidence is highly doubtful (p = 0.56). However, it is very well possible that there is a further interaction in the data with other variables or unknown variables that this simpler version of the model cannot identify. This is partly evidenced by the fact that the overall variance explained is still low, with an adjusted \emph{r\textsuperscript{2}} of 0.23.
...
\midrule
\endhead
\textbf{(Intercept)} & 12.72 & 7.52 & 1.69 & 0.09 \\
\textbf{DeltaF\_perc\_pos} & 0.29 & 0.1 & 2.86 & 0 \\
\textbf{Forest\_SignIncrease} & -35.76 & 5.57 & -6.42 & 0 \\
\textbf{Dryness} & 5.28 & 3.16 & 1.67 & 0.1 \\
\textbf{log10(Area\_km2)} & 0.03 & 2.39 & 0.01 & 0.99 \\
\textbf{Dryness:log10(Area\_km2)} & -2.52 & 1.39 & -1.81 & 0.07 \\
\bottomrule
\end{longtable}
...
\midrule
\endhead
\textbf{(Intercept)} & 14.77 & 5.75 & 2.57 & 0.01 \\
\textbf{DeltaF\_perc\_pos} & 0.33 & 0.1 & 3.49 & 0 \\
\textbf{Forest\_SignIncrease} & -38.53 & 5.61 & -6.87 & 0 \\
\bottomrule
\end{longtable}
...
\midrule
\endhead
\textbf{s(log10(Area\_km2))} & 0.59 & 9 & 0.2 & 0.08 \\
\textbf{s(Dryness)} & 4.19 & 9 & 0.86 & 0.09 \\
\textbf{s(length)} & 0 & 9 & 0 & 0.55 \\
\textbf{s(From)} & 5.35 & 9 & 1.05 & 0.09 \\
\bottomrule
\end{longtable}

Including non-linearity (Equation \eqref{eq:eq7}) increases the overall explaining power of the model to an adjusted \emph{r\textsuperscript{2}} of 0.27 and deviance explained of 0.29, but creates a few changes in the significance of the variables (Table \ref{tab:mfive-smooth}). For example, the smoothed variable for Area (km\textsuperscript{2}) (p = 5.35)) and Dryness (p = 9))still provides reasonable explanation of changes in stream flow. However \emph{length} does not explain any of the variation. In contrast, \emph{From}, which indicates the start date of the study (and therefore the age of the study) has an effect (p = 0.09)).\\
...
\midrule
\endhead
\textbf{(Intercept)} & -26.15 & 18.59 & -1.41 & 0.16 \\
\textbf{DeltaF\_perc\_pos} & 0.29 & 0.1 & 3.05 & 0 \\
\textbf{Forest\_SignIncrease} & -23.79 & 7.04 & -3.38 & 0 \\
\textbf{Precip\_data\_typeOB} & -6.89 & 14.24 & -0.48 & 0.63 \\
\textbf{Precip\_data\_typeSG} & 19.59 & 15.77 & 1.24 & 0.22 \\
\textbf{Assessment\_techniqueEA, HM} & 18.33 & 45.34 & 0.4 & 0.69 \\
\textbf{Assessment\_techniqueHM} & 31.53 & 12.7 & 2.48 & 0.01 \\
\textbf{Assessment\_techniquePWE} & 53.37 & 11.93 & 4.47 & 0 \\
\textbf{Assessment\_techniquePWE,
HM} & 46.51 & 46.35 & 1 & 0.32 \\
\textbf{Assessment\_techniqueQPW} & 41.17 & 21.62 & 1.9 & 0.06 \\
\textbf{Assessment\_techniqueQPW,
EA} & 32.24 & 27.41 & 1.18 & 0.24 \\
\textbf{Assessment\_techniqueSH} & 42.47 & 12.58 & 3.38 & 0 \\
\textbf{Forest\_typeCF} & -4.11 & 8.38 & -0.49 & 0.62 \\
\textbf{Forest\_typeMF} & -10.52 & 8.14 & -1.29 & 0.2 \\
\textbf{Hydrological\_regimeSD} & 7.68 & 10.4 & 0.74 & 0.46 \\
\bottomrule
\end{longtable}
...
\midrule
\endhead
\textbf{s(log10(Area\_km2))} & 0 & 9 & 0 & 0.41 \\
\textbf{s(Dryness)} & 3.86 & 9 & 1.64 & 0 \\
\textbf{s(length)} & 0 & 9 & 0 & 0.31 \\
\textbf{s(From)} & 8.8 & 9 & 3.53 & 0 \\
\bottomrule
\end{longtable}
...
\midrule
\endhead
\textbf{s(Dryness)} & 2.85 & 9 & 2.39 & 0 \\
\textbf{s(log10(Area\_km2))} & 0.43 & 9 & 0.09 & 0.15 \\
\textbf{s(length)} & 0 & 9 & 0 & 0.37 \\
\textbf{s(From)} & 3.91 & 9 & 0.66 & 0.17 \\
\bottomrule
\end{longtable}
...
\midrule
\endhead
\textbf{(Intercept)} & -24.6 & 18.66 & -1.32 & 0.19 \\
\textbf{DeltaF\_perc\_pos} & 0.27 & 0.1 & 2.76 & 0.01 \\
\textbf{Forest\_SignIncrease} & -22.57 & 7.02 & -3.21 & 0 \\
\textbf{Precip\_data\_typeOB} & -13.54 & 14.15 & -0.96 & 0.34 \\
\textbf{Precip\_data\_typeSG} & 18.35 & 16.1 & 1.14 & 0.26 \\
\textbf{Assessment\_techniqueHM} & 34.7 & 12.65 & 2.74 & 0.01 \\
\textbf{Assessment\_techniquePWE} & 57.63 & 12.48 & 4.62 & 0 \\
\textbf{Assessment\_techniqueQPW} & 43.25 & 21.29 & 2.03 & 0.04 \\
\textbf{Assessment\_techniqueSH} & 48.72 & 12.48 & 3.9 & 0 \\
\textbf{Forest\_typeCF} & -6.27 & 8.31 & -0.75 & 0.45 \\
\textbf{Forest\_typeMF} & -5.53 & 8.24 & -0.67 & 0.5 \\
\textbf{Hydrological\_regimeSD} & 8.79 & 10.39 & 0.85 & 0.4 \\
\bottomrule
\end{longtable}
...
\midrule
\endhead
\textbf{s(Dryness)} & 2.84 & 9 & 2.33 & 0 \\
\textbf{s(log10(Area\_km2))} & 0.41 & 9 & 0.09 & 0.16 \\
\textbf{s(length)} & 0 & 9 & 0 & 0.36 \\
\textbf{s(From)} & 3.91 & 9 & 0.65 & 0.18 \\
\bottomrule
\end{longtable}
