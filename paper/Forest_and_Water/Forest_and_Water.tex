...
\midrule
\endhead
\textbf{(Intercept)} & 9.88 & 5.42 & 1.82 & 0.07 \\
\textbf{DeltaF\_perc\_pos} & 0.44 & 0.08 & 5.68 & 0 \\
\textbf{Forest\_SignIncrease} & -35.72 & 5.21 & -6.86 & 0 \\
\textbf{Latitude} & -0.1 & 0.09 & -1.17 & 0.24 \\
\textbf{Longitude} & -0.02 & 0.03 & -0.62 & 0.54 \\
\bottomrule
\end{longtable}
...
\midrule
\endhead
\textbf{(Intercept)} & 7.13 & 6.86 & 1.04 & 0.3 \\
\textbf{DeltaF\_perc\_pos} & 0.31 & 0.09 & 3.33 & 0 \\
\textbf{Forest\_SignIncrease} & -30.74 & 5.1 & -6.02 & 0 \\
\textbf{Dryness} & 7.05 & 2.86 & 2.46 & 0.01 \\
\textbf{log10(Area\_km2)} & 0.64 & 2.19 & 0.29 & 0.77 \\
\textbf{Dryness:log10(Area\_km2)} & -3.23 & 1.29 & -2.5 & 0.01 \\
\bottomrule
\end{longtable}
...
\midrule
\endhead
\textbf{(Intercept)} & 12.09 & 5.31 & 2.28 & 0.02 \\
\textbf{DeltaF\_perc\_pos} & 0.3 & 0.09 & 3.27 & 0 \\
\textbf{Forest\_SignIncrease} & -30.5 & 5.62 & -5.43 & 0 \\
\bottomrule
\end{longtable}
...
\midrule
\endhead
\textbf{s(log10(Area\_km2))} & 1.95 & 5 & 1.43 & 0.02 \\
\textbf{s(Dryness)} & 4.62 & 9 & 1.81 & 0 \\
\textbf{s(length)} & 28.4 & 49 & 1.2 & 0 \\
\bottomrule
\end{longtable}
...
\midrule
\endhead
\textbf{(Intercept)} & -22.77 & 18.14 & -1.26 & 0.21 \\
\textbf{DeltaF\_perc\_pos} & 0.31 & 0.09 & 3.33 & 0 \\
\textbf{Forest\_SignIncrease} & -21.42 & 6.58 & -3.25 & 0 \\
\textbf{Precip\_data\_typeOB} & -11.41 & 13.41 & -0.85 & 0.4 \\
\textbf{Precip\_data\_typeSG} & 3.29 & 16.54 & 0.2 & 0.84 \\
\textbf{Assessment\_techniqueEA, HM} & 12.7 & 43.18 & 0.29 & 0.77 \\
\textbf{Assessment\_techniqueHM} & 37.34 & 12.44 & 3 & 0 \\
\textbf{Assessment\_techniquePWE} & 49.63 & 12.95 & 3.83 & 0 \\
\textbf{Assessment\_techniquePWE,
HM} & 39.85 & 42.28 & 0.94 & 0.35 \\
\textbf{Assessment\_techniqueQPW} & 46.12 & 20.21 & 2.28 & 0.02 \\
\textbf{Assessment\_techniqueQPW,
EA} & 50.81 & 24.17 & 2.1 & 0.04 \\
\textbf{Assessment\_techniqueSH} & 42.84 & 12.22 & 3.51 & 0 \\
\textbf{Forest\_typeCF} & -11.16 & 7.54 & -1.48 & 0.14 \\
\textbf{Forest\_typeMF} & -1.81 & 7.8 & -0.23 & 0.82 \\
\textbf{Hydrological\_regimeSD} & 11.44 & 9.16 & 1.25 & 0.21 \\
\bottomrule
\end{longtable}
...
\midrule
\endhead
\textbf{s(Dryness)} & 3.12 & 9 & 2.65 & 0 \\
\textbf{s(log10(Area\_km2))} & 0.53 & 4 & 0.3 & 0.13 \\
...
This last model has more explaining power with an adjusted \emph{r\textsuperscript{2}} of 0.33. The results indicate that \emph{Dryness} indicates a clear signifcant non-linear response where changes in forest cover in drier catchments having a greater impact on streamflow (Figure \ref{fig:smoothsmodel7} and Table \ref{tab:restrictlength}). Catchment area (\emph{log10(Area (km\textsuperscript{2}))}) also shows reasonable evidence of having an impact on flow with p = 0.13, and suggesting once again that changes in forest cover in larger catchments have less impact on streamflow. The variable \emph{length} no longer is significant, after removal of the two studies with very long lengths.
...
\midrule
\endhead
\textbf{(Intercept)} & -25.35 & 16.81 & -1.51 & 0.13 \\
\textbf{DeltaF\_perc\_pos} & 0.29 & 0.09 & 3.25 & 0 \\
\textbf{Forest\_SignIncrease} & -22.67 & 6.23 & -3.64 & 0 \\
\textbf{Precip\_data\_typeOB} & -8.99 & 12.42 & -0.72 & 0.47 \\
\textbf{Precip\_data\_typeSG} & 9 & 14.41 & 0.62 & 0.53 \\
\textbf{Assessment\_techniqueHM} & 37.79 & 11.38 & 3.32 & 0 \\
\textbf{Assessment\_techniquePWE} & 51.85 & 11.55 & 4.49 & 0 \\
\textbf{Assessment\_techniqueQPW} & 43.98 & 19.18 & 2.29 & 0.02 \\
\textbf{Assessment\_techniqueSH} & 42.26 & 11.51 & 3.67 & 0 \\
\textbf{Forest\_typeCF} & -9.09 & 7.17 & -1.27 & 0.21 \\
\textbf{Forest\_typeMF} & -1.9 & 7.47 & -0.25 & 0.8 \\
\textbf{Hydrological\_regimeSD} & 5.54 & 8.88 & 0.62 & 0.53 \\
\bottomrule
\end{longtable}
...
\midrule
\endhead
\textbf{s(Dryness)} & 3.11 & 9 & 2.59 & 0 \\
\textbf{s(log10(Area\_km2))} & 0.51 & 9 & 0.13 & 0.13 \\
\textbf{s(length)} & 0 & 9 & 0 & 0.96 \\
\bottomrule
\end{longtable}
